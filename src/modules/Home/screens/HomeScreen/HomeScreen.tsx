      ...
      >
        ...
        <Section title="Form">
          <Card className="gap-4 p-4">
            <TextInput label="Email" placeholder="you@example.com" autoCapitalize="none" keyboardType="email-address" />
            <TextInput label="Password" placeholder="Obrigatório" secureTextEntry error="Password is required" />
          </Card>
        </Section>
